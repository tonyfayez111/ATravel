...
export default function MiniCard( {image, title, price, rate, numberOfReviews} : MiniCardProps) {
  return(
    
    <div className="flex flex-col  w-[70%]  md:w-[292px]   md:h-[388px]  rounded-[10px] overflow-hidden  font-poppins">
      <Image
        src={image}
        alt={"picture"}
